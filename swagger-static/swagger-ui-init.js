  ...
  "swaggerDoc": {
    ...
    "paths": {
      "/sa/users": {
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CreateUserInputClassModel"
                }
              }
            }
          },
        ...
        "delete": {
          "operationId": "UsersAdminController_deleteAllUser",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
      ...
      "/sa/users/{id}/ban": {
        "put": {
          "operationId": "UsersAdminController_updateBanInfo",
          "parameters": [
            {
              "name": "id",
              "required": true,
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/InfoBanStatusClassModel"
                }
              }
            }
          },
      ...
      "/sa/users/banned": {
        "get": {
          "operationId": "UsersAdminController_GetBannedUser",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/checkEmailInputClassModel"
                }
              }
            }
          },
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/codeInputClassModel"
                }
              }
            }
          },
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/loginInputClassModel"
                }
              }
            }
          },
      ...
      "/auth/me": {
        "get": {
          "operationId": "AuthController_getOwnAccount",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
      ...
      "/users": {
        ...
        "delete": {
          "operationId": "UsersController_deleteAllUser",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
      ...
      "/sa/blogs/{blogId}/bind-with-user/{userId}": {
        "put": {
          "operationId": "BlogsController_bindUserToBlog",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/BlogInputClassModel"
                }
              }
            }
          },
      ...
      "/blogger/blogs/{id}": {
        "get": {
          "operationId": "BlogsBloggerController_getBlog",
          "parameters": [
            {
              "name": "id",
              "required": true,
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CreatePostForBlogInputClassModel"
                }
              }
            }
          },
      ...
      "/blogger/blogs/{blogId}/posts/{postId}": {
        "put": {
          "operationId": "BlogsBloggerController_updatePost",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
        ...
        "delete": {
          "operationId": "BlogsBloggerController_deletePostByBlog",
          "parameters": [
            {
              "name": "blogId",
              "required": true,
      ...
      "/blogs/{id}": {
        "get": {
          "operationId": "BlogsPublicController_getBlog",
          "parameters": [
            {
              "name": "id",
              "required": true,
      ...
      "/blogs/{id}/posts": {
        "get": {
          "operationId": "BlogsPublicController_GetPostsByBlog",
          "parameters": [
            {
              "name": "id",
              "required": true,
      ...
      "/posts": {
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CreatePostInputClassModel"
                }
              }
            }
          },
        ...
        "delete": {
          "operationId": "PostsController_deleteAllPost",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
      ...
      "/posts/{id}/comments": {
        "get": {
          "operationId": "PostsController_getCommentByPost",
          "parameters": [
            {
              "name": "id",
              "required": true,
        ...
        "post": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CreateCommentInputClassModel"
                }
              }
            }
          },
      ...
      "/posts/{id}/like-status": {
        "put": {
          "operationId": "PostsController_updateLikesInfoByPostId",
          "parameters": [
            {
              "name": "id",
              "required": true,
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/likeStatusInputClassModel"
                }
              }
            }
          },
      ...
      "/security/devices": {
        ...
        "delete": {
          "operationId": "SecurityController_deleteAllDevices",
          "parameters": [],
          "responses": {
            "200": {
              "description": ""
      ...
      "/security/devices/{deviceId}": {
        "delete": {
          "operationId": "SecurityController_deleteDeviceById",
          "parameters": [
            {
              "name": "deviceId",
              "required": true,
        ...
        "put": {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/commentContentInputClassModel"
                }
              }
            }
          },
      ...
      "/comments/{id}/like-status": {
        "put": {
          "operationId": "CommentsController_updateLikeByCommentId",
          "parameters": [
            {
              "name": "id",
              "required": true,
    ...
    "components": {
      "schemas": {
        "InfoBanStatusClassModel": {
          "type": "object",
          "properties": {}
        },
        "CreateUserInputClassModel": {
          "type": "object",
          "properties": {}
        },
